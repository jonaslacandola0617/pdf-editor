  ...
  return <>
    ...
    {objectsOpen && <div className="modal-backdrop native-object-backdrop" onMouseDown={() => setObjectsOpen(false)}>
      <section className="native-object-modal" onMouseDown={(event) => event.stopPropagation()} aria-label="Embedded PDF objects">
        <header>
          <div><span className="eyebrow">PDF STRUCTURE & LOCAL ASSETS</span><h2>Objects, navigation & signatures</h2><p>Manage native PDF objects, interactive form properties, reusable signatures, page labels, initial-view preferences and local page-image exports.</p></div>
